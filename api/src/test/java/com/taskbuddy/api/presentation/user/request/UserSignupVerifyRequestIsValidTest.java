...
class UserSignupVerifyRequestIsValidTest {
    private UserSignupVerifyRequest sut;
    ...
    void email이_null이거나_빈값이면_false를_반환한다(String givenEmail) {
        sut = new UserSignupVerifyRequest(givenEmail, MOCK_USERNAME, MOCK_PASSWORD);
    ...
    void username이_null이거나_빈값이면_false를_반환한다(String givenUsername) {
        sut = new UserSignupVerifyRequest(MOCK_EMAIL, givenUsername, MOCK_PASSWORD);
    ...
    void password가_null이거나_빈값이면_false를_반환한다(String givenPassword) {
        sut = new UserSignupVerifyRequest(MOCK_EMAIL, MOCK_USERNAME, givenPassword);

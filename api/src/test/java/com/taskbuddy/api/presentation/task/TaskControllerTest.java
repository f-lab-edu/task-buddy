...
public class TaskControllerTest implements MySqlTestContainers {
    ...
    @MockBean
    private TaskReminderJpaRepository taskReminderJpaRepository;
    ...
    void 사용자는_Task를_생성할_수_있다() throws Exception {
        ...
        TaskEntity mockTask = TaskEntity.builder()
                ...
                .endDateTime(givenEndDateTime)
                .createdAt(LocalDateTime.now())
                .updatedAt(LocalDateTime.now())
                .build();
        Mockito.when(taskRepository.save(Mockito.any(TaskEntity.class))).thenReturn(mockTask);
